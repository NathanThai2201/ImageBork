...
global_palette_names = ["Nostalgi-2","1-Bit Error-4","Tinyfolks-5","Midnight Ablaze-7","Eublink-7","Deep Maze-7","Rust Gold-8","Dry Sea-10","Vibe-20","Vaporsthetic-20","Wintercode-36","null"]
global_palettes = [
...
def show_palettes():
    ...
    for idx, palette in enumerate(global_palettes):
        ...
        ax.set_axis_off()
        ax.set_title(f"{global_palette_names[idx]} | Palette number: {idx}", loc='left',fontsize=8, y=0.8)
